...
import { X, Loader2, CheckCircle2, Calculator, AlertTriangle, User, Key, Settings, Map, Trash2, PackageMinus, Banknote, DollarSign, Image as ImageIcon, Printer, ArrowLeftRight, CalendarClock, ChevronRight, History } from 'lucide-react';
import { formatCurrency, imprimirFacturaCliente } from '../../utils/adminUtils';

const AdminModals = ({ states, forms, setters, handlers, data }) => {
    // 1. Extraemos todo lo que el Dashboard nos envía por "paquetes" (Props)
    ...
    const { categorias, usuarios, rutasDinamicas, diasUnicosDropdown, clienteActualData } = data;

    // 2. Aquí van todos los modales (sin ensuciar el archivo principal)
    return (
        <>
